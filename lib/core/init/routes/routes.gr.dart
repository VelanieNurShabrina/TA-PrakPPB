...
import '../../../features/account/view/widgets/about.dart' as _i15;
...
class AppRouter extends _i21.RootStackRouter {
  ...
  List<_i21.RouteConfig> get routes => [
        ...
        _i21.RouteConfig(about.name, path: '/about'),
...
/// generated route for
/// [_i15.about]
class about extends _i21.PageRouteInfo<void> {
  const about() : super(about.name, path: '/about');
